...
const FooterCard = async (Icon) => {
  ...
  console.log(currYear, prevYear, currMonth, prevMonth)
  const footerData = await getFooterData(currYear, prevYear, currMonth, prevMonth)
  console.log(footerData.currMonthActual, footerData.prevMonthActual)
  ...
  console.log("monthhhhhhchannnngee: ", monthChangePercent)
  return (
