...
export default function Invoicepdf(args) {
  ...
  const totalInvoiceValue = parseFloat(
    (calcValue + 2 * calcValueWithRate).toFixed(4)
  );
  ...
  const handleDownload = async () => {
    ...
    html2canvas(inputArea, { scale: 2, scrollY: -window.scrollY }).then(
      (canvas) => {
        ...
        const scaleY =
          ...
          ((canvas.height * scaleX) /
            ((scaleX * imgProps.width) / imgProps.height));
      ...
      <div className="m-auto max-w-screen-lg border-2 border-black">
        ...
        <div className="mt-2 grid p-1 sm: grid-cols-12 gap-2 w-full">
          ...
          <div className="min-h-[50px] flex flex-col  sm: col-span-4">
            ...
            <span className="text-xs">
              {data.invoicePeriodFrom} to {data.invoicePeriodTo}
            </span>
          </div>
          <div className="min-h-[50px] flex flex-col sm: col-span-4">
          ...
          <Table className=" mt-2 border border-black">
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="text-sm font-medium text-black">
                  HSN Code
                </TableHead>
                <TableHead className="text-sm font-medium text-black">
                  Taxable Value
                ...
                <TableHead className="text-right text-sm font-medium text-black">
                  <span className="flex justify-center w-full border-b border-black">
                    CGST
                  </span>
            ...
            <TableBody>
              <TableRow>
                <TableCell className="text-xs">
                  Purchase of renewable attributes for I-REC ({data.issued}{" "}
                  units at INR {data.netRate} per unit)
                </TableCell>
          ...
          <div className="min-h-[50px] flex flex-col sm: col-span-12">
            ...
            <span className="text-xs px-4">
              <ul className="list-disc">
                ...
                <li>
                  The due date for payment of invoices shall be the date of
                  issue of the invoice (&apos;the due date&apos;).
                </li>
                <li>
                  For payment by cheques, please issue crossed cheque in favour
                  of Solaura Power Private Limited.
                </li>
                <li>
                ...
                <li>
                  If the payment is through NEFT/online transfer, please refer
                  the invoice number in payment description.
                </li>
              </ul>
            </span>
          </div>
